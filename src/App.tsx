...
import { AdminStudentDataPage } from "./pages/admin/AdminStudentDataPage";
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="student-data" element={<AdminStudentDataPage />} />
          <Route path="student-data/:studentId" element={<AdminStudentDataPage />} />
